clc; clear;
%{
first version that was used in diplom
uses Boundary.m, projection.m, reverseBoundary.m
%}
...
xu = Boundary(CorrectX(s,1), CorrectU);
    ...
    figure
    hold on;
    plot(CorrectX(2*S_steps/L+1,:),'-')
    plot(xu(2*S_steps/L+1, :),'--')
    legend({'�������������', '���������'});
    set(gca, 'XtickLabel', {0:0.5:4});
    xlabel('t')
    ylabel('x(s=2, t)')
    ...
    figure
    hold on;
    plot(CorrectX(5*S_steps/L+1,:),'-')
    plot(xu(5*S_steps/L+1, :),'--')
    legend({'�������������', '���������'});
    set(gca, 'XtickLabel', {0:0.5:4});
    xlabel('t')
    ylabel('x(s=5, t)')
    ...
    figure
    hold on;
    plot(CorrectX(:,5*T_steps/T+1),'-')
    plot(xu(:, 5*T_steps/T+1),'--')
    legend({'�������������', '���������'});
    set(gca, 'XtickLabel', {0:0.5:4});
    xlabel('s')
    ylabel('x(s, t=5)')
